    ...
    try {
      ...
      setTimeout(() => {
        const mockProjects = [
          { 
            id: '1', 
            title: 'Qualitative Research Project', 
            description: 'Research on user experience in healthcare applications',
          ...
          { 
            ...
            description: 'Analysis of consumer behavior in digital markets',
          ...
          { 
            ...
            description: 'Thematic analysis of stakeholder feedback interviews',
                        ...
                        {projects.map((project) => (
                          ...
                          >
                                ...
                                <Box>
                                  ...
                                  {isMobile ? (
                                    <Stack direction="row" spacing={1} alignItems="center">
                                      <StatusAvatar status={project.status} />
                            ...
                            {!isMobile && (
                              <TableCell>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                  ...
                                  <Typography>{project.documentCount}</Typography>
                                </Box>
                              </TableCell>
                            )}
                            ...
                            {!isMobile && (
                              <TableCell>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                  <Typography>{project.codeCount}</Typography>
                                </Box>
                              </TableCell>
                            )}
