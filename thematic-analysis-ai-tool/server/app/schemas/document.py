...
class DocumentSegment(DocumentSegmentOut):
...
class DocumentContent(BaseModel):
    ...
    total_segments: int
    segmentation_type: Literal["line", "line_by_page", "sentence", "csv_row"]
...
class DocumentWithSegments(DocumentOut):
    """Document with all its segments for comprehensive project loading"""
